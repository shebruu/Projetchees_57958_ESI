...
public class BoardTest {
    ...
    public void testContainsOppositeColorSameColorWhite() {
        ...
        board.setPiece(new Piece(Color.WHİTE), pos);
        assertFalse(board.containsOppositeColor(pos, Color.WHİTE));
    }
    ...
    public void testContainsOppositeColorOppositionColorBW() {
        ...
        Position pos = new Position(7, 7);
        board.setPiece(new Piece(Color.BLACK), pos);
        assertTrue(board.containsOppositeColor(pos, Color.WHİTE));
    }
